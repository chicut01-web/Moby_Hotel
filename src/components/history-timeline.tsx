 ...
 * tratteggiata che si inchiostra con lo scroll (stesso pattern
 * stroke-dashoffset + animation-timeline della traversata; classi
 * `.timeline-ink` in globals.css), con le cinque tappe rivelate in
 * cascata. Senza scroll-driven animations resta la guida tratteggiata.
 */
