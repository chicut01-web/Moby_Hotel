/**
 * Gli archi del logo HEY!, ripetuti: la "corona" del marchio — archi a
 * tutto sesto del chiostro, ad alto slancio verticale — e sotto la linea
 * di base con lo stesso spessore, come la descrive il manuale d'identità.
 *
 * Il tracciato non è ridisegnato: è l'arco del logo vettoriale
 * (public/brand), con le sue misure. Pieno, colorato con currentColor; il
 * manuale li usa come supergrafica ripetuta e schiarita sui fondi.
 */
...
export function ArchColonnade({
  ...
  className?: string;
  count?: number;
  /** La linea orizzontale sotto gli archi: il basamento del logo. */
  base?: boolean;
}) {
